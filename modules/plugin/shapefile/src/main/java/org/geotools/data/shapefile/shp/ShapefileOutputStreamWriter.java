...
public class ShapefileOutputStreamWriter implements Closeable {
    ...
    private ByteArrayOutputStream shpOutputStream = new ByteArrayOutputStream();
    private ByteArrayOutputStream shxOutputStream = new ByteArrayOutputStream();
     ...
     * ShapeType.
     */
    public ByteArrayOutputStream[] writeOutputStream(GeometryCollection geometries, ShapeType type)
            throws IOException, ShapefileException {
        handler = type.getShapeHandler(gf);
