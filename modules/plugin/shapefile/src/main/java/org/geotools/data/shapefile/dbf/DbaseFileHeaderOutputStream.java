...
public class DbaseFileHeaderOutputStream {
    ...
    public DbaseFileHeaderOutputStream() {
        this.charset = Charset.defaultCharset();
    }

    public DbaseFileHeaderOutputStream(Charset charset) {
    ...
    public void writeHeader(ByteArrayOutputStream out) throws IOException {
        // take care of the annoying case where no records have been added...
        if (headerLength == -1) {
            headerLength = MINIMUM_HEADER;
        }
