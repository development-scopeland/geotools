...
public class DbaseFileInputStreamReader implements FileReader, Closeable {
     ...
     */
    public DbaseFileInputStreamReader(
    ...
    public DbaseFileInputStreamReader(InputStream dbf) throws IOException {
        this.useMemoryMappedBuffer = true;
        this.initInputStream(dbf, null, null);
    }
    ...
    private void  initInputStream(InputStream dbf, final Charset charset, final TimeZone timeZone) throws IOException {
        ...
        byte[] byteArr = new byte[dbf.available()];
        dbf.read(byteArr);
     ...
     */
    public Object readField(final int fieldNum) throws IOException {
